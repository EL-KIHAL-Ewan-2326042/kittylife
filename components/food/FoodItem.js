    ...
    const panResponder = PanResponder.create({
        ...
        onPanResponderRelease: (evt, gestureState) => {
            if (catPosition) {
                ...
                // Calculer la zone de détection avec marge
                const marginX = catPosition.width * 0.3; // 30% de la largeur comme marge
                const marginY = catPosition.height * 0.3; // 30% de la hauteur comme marge

                const isOverCat =
                    touchX >= catPosition.x - marginX &&
                    touchX <= catPosition.x + catPosition.width + marginX &&
                    touchY >= catPosition.y - marginY &&
                    touchY <= catPosition.y + catPosition.height + marginY;
        ...
        <Animated.View
            ...
            style={[
                styles.foodItem,
                {
                    ...
                    left: initialPosition.current.x + 120, // Centre du demi-cercle
                    top: initialPosition.current.y + 120,  // Centre du demi-cercle
